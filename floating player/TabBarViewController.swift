...
//    }
    ...
    func setupViews() {
        ...
        playerVC.playerFrameDelegate = self
    ...
    func handlePan(_ sender: UIPanGestureRecognizer, playerState: PlayerState) {
        ...
        case .minimized:
            ...
            playerContainerView.frame.origin = CGPoint(x: playerContainerView.frame.origin.x + translation.x, y: max(0, playerContainerView.frame.origin.y + translation.y))
